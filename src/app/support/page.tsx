        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-2xl p-8 mb-6">
            ...
            <div className="divide-y divide-gray-700">
              {([
                ...
                ['How do I install iFly (sideload)?', <>iFly is distributed via sideloading for iOS and tvOS. We recommend using <a href="https://sideloadly.io" target="_blank" rel="noopener noreferrer" className="text-orange-400 hover:underline">Sideloadly</a> to install the app on your device. For enabling JIT on Apple TV, ask in our <a href="https://discord.gg/4TK7PU5" target="_blank" rel="noopener noreferrer" className="text-orange-400 hover:underline">Discord</a> for current JIT enabler recommendations.</>],
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-2xl p-8 mb-6">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <a href="https://discord.gg/4TK7PU5" target="_blank" rel="noopener noreferrer"
                 className="flex items-start gap-4 p-5 bg-gray-800/40 border border-gray-700/50 rounded-xl hover:border-gray-600 transition-colors group">
