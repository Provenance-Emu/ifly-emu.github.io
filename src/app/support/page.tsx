          ...
          <div className="bg-gray-900 border border-gray-800 rounded-2xl p-8 mb-6">
            ...
            <div className="divide-y divide-gray-700">
              {([
                ...
                ['Does iFly include games or BIOS?', <>No. iFly ships no Dreamcast ROMs and no BIOS. For legal reasons you provide your own game files (CHD, CDI, or GDI) and, where a title needs it, your own Dreamcast BIOS. Import them over Wi-Fi with the built-in web server or via the Files app.</>],
                ['How do I install iFly (sideload)?', <>iFly is distributed via sideloading for iOS and tvOS. We recommend using <a href="https://sideloadly.io" target="_blank" rel="noopener noreferrer" className="text-orange-400 hover:underline">Sideloadly</a> to install the app on your device. For enabling JIT on Apple TV, ask in our <a href="https://discord.gg/QF5ZjVT4Sa" target="_blank" rel="noopener noreferrer" className="text-orange-400 hover:underline">Discord</a> for current JIT enabler recommendations.</>],
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <a href="mailto:support@ifly-emu.com?subject=iFly%20Support"
                ...
                <div>
                  ...
                  <span className="text-sm text-orange-400 group-hover:underline">support@ifly-emu.com</span>
                </div>
              </a>
